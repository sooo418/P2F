...
<link rel='stylesheet' href='${pageContext.request.contextPath}/fullcal/lib/cupertino/jquery-ui.min.css' />
<link href='${pageContext.request.contextPath}/fullcal/fullcalendar.css' rel='stylesheet' />
<link href='${pageContext.request.contextPath}/fullcal/fullcalendar.print.css' rel='stylesheet'
	media='print' />
				...
				<section>
					...
					<form method="post" action="" name="f"
						...
						<div class="row gtr-uniform gtr-50">
							...
							<div class="col-6 col-12-xsmall">
								<input type="hidden" name="id" id="demo-email" value="${user.id}"
									placeholder="ID입력" />
							</div>
							<div class="col-6 col-12-xsmall">
							...
							<input type="hidden" name="latitude" id="lat" value=""> <input
