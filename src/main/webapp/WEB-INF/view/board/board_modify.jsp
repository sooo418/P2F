					...
					<div class="row gtr-uniform gtr-50">
						...
						<div class="col-12">
							<select name="open" id="demo-category">
								<option value="${board.open}">- 공개여부 -</option>
						...
						<div class="col-12">
							<textarea name="bcontent" id="demo-message"
								placeholder="Enter your message" rows="6">${board.bcontent}</textarea>
						...
						<input type="hidden" name="img" id="demo-name"
							value="${board.img}" placeholder="이미지를 등록하세요" />
						...
						<div class="col-6 col-12-xsmall">
							<input type="hidden" name="latitude" id="latitude"
								value="${board.latitude}"> <input type="hidden"
								name="longitude" id="longitude" value="${board.longitude}">
						</div>
						...
						<div class="col-12">
							<ul class="actions">
								<li><input type="button" value="수정 완료"
									onClick="boardUpdate()" class="primary"></li>
