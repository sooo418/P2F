	...
	<div id="main">
		...
		<section id="three">
			...
			<div class="col-8 col-12-small">
				<form name="tform" method="post" action="./add.do">
					<input type="hidden" name="id" id="id" value="${user.id}">
					<div class="col-12">
						<select style="border: solid 2px #18e78f;" class="todoselect"
							name="year" id="year">
							<option value="2019">- 년도 -</option>
					...
					<input style="border: solid 2px #18e78f; margin: 0.5em 0 0.5em 0;"
						...
						value=""> <font color="red"><form:errors
					...
					<ul class="actions">
						<li><input style="border: solid 3px #18e78f;" type="submit"
							value="Add Schedule" /></li>
					</ul>
				</form>
			</div>
